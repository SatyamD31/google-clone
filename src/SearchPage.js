...
function SearchPage() {
    ...
    // LIVE API Call
    const { data } = useGoogleSearch(term);          // returned data from useGoogleSearch
    ...
    return (
        <div className="searchPage">
            ...
            {/* render search results only if a search term is provided */}
            {term && (
                    ...
                    {data?.items.map(item => (
                        <div className="searchPage__result">
                            <a className="searchPage__resultLink" href={item.link}>
                                ...
                                {item.displayLink} <ArrowDropDownIcon /></a>
